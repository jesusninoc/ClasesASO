# Administración de servicio de directorio (sistemas operativos, Windows, Linux, scripting, PowerShell, virtualización, Directorio Activo, resolución de incidencias)
...
# Administración de procesos del sistema (sistemas operativos, Windows, Linux, scripting, PowerShell, monitorización, Directorio Activo, resolución de incidencias)
...
# Información del sistema (sistemas operativos, Windows, Linux, scripting, PowerShell, monitorización, resolución de incidencias)
...
# Instalación, configuración y uso de servicios de acceso y administración remota (sistemas operativos, Windows, Linux, scripting, PowerShell, monitorización, redes resolución de incidencias)
...
# Administración de servidores de aplicaciones (sistemas operativos, Windows, Linux, scripting, PowerShell, monitorización, redes resolución de incidencias)
...
# Administración de servidores de impresión (sistemas operativos, Windows, Linux, scripting, PowerShell, monitorización, redes resolución de incidencias)
...
# Integración de sistemas operativos en red libres y propietarios (sistemas operativos, Windows, Linux, scripting, PowerShell, monitorización, redes resolución de incidencias)
...
# Aplicación de lenguajes de «scripting» en sistemas operativos libres y propietarios (Windows, Linux, scripting, PowerShell)
