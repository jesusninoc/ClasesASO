- Monitorización
  - Enseñar Zabbix (preparar máquina para instalar el próximo día con Docker)
- Azure
...
- Optimización de scripts
  - PowerShell
    ...
    - https://www.jesusninoc.com/04/03/instalar-el-modulo-que-contiene-cmdlets-disenados-para-funcionar-con-dsc-resources-psdesiredstateconfiguration/
    - https://www.jesusninoc.com/01/03/configuracion-declarativa-basica-comprobar-servicio-w32time/
  - Bash 
```Bash
