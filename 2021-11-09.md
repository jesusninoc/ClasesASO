...
function damehilos()
{
    Write-Host (Get-Process -Name $args[0]).Threads.id -ForegroundColor $args[1]
}

damehilos notepad Cyan
############################################################
function suma() { echo $1+$2+$3 | bc; }
suma 1 2 3
############################################################
cat script.sh
echo $1+$2+$3 | bc
...
echo $args[0]
##############################
$resutlado = & '.\Sin título3.ps1' 3
############################################################
Llamar a un script de Linux que tenga una función de suma desde un script de PowerShell
...
# Llamar al script.sh desde PowerShell (creando un script)
wsl /root/script.sh $args[0] $args[1] $args[2]

# Llamada al script de PowerShell
& '.\Sin título3.ps1' 3 3 4
```
